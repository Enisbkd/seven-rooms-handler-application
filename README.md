...
To build the final jar and optimize the sevenRoomsHandlerApplication application for production, run:
...
Then navigate to [http://localhost:4040](http://localhost:4040) in your browser.
