      ...
      this.userManagementService
        ...
        .then(res => {
          this.alertService.showInfo(
            this.t$(res.headers['x-sevenroomshandlerapplicationapp-alert'].toString(), {
              param: decodeURIComponent(res.headers['x-sevenroomshandlerapplicationapp-params'].replace(/\+/g, ' ')),
            }),
            { variant: 'danger' },
          );
          this.removeId = null;
